...
TIP: Un bonne connaissance des possiblités des sélecteurs CSS s'impose ici. C'est une bonne raison de
...
* Concevoir une nouvelle spécification (un nouveu test unitaire) qui vérifie que la température
