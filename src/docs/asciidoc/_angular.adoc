...
----
puis mettons a jour `composer.json`:
...
// devra, au moins, implémenter ce modèle (basé sur un API vue plus loin)
...
Nous allons maintenant vérifier que le composant réagit bien aux changements de valeur de certains de ses propriétés :
